Pod::Spec.new do |s|
  ...
  s.homepage = 'https://github.com/Navirize/SDWebImage'
  s.author = { 'Ahmed Hamdy' => 'hamdy@navirize.com' }
  s.source = { :git => 'https://github.com/Navirize/SDWebImage.git', :tag => s.version.to_s }
